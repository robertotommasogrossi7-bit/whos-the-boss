...
>
> 📦 **ARCHIVIATO in `_processo/archivio/` il 2026-06-01.** Restano vivi solo i
> ragionamenti sulla **fase 8 (post-backend)**: spartiacque backend, spettatori del
> tavolo, ruoli/permessi. Il resto è superato (vedi sotto).
>
> Stato: idee discusse con l'utente il 2026-05-21. ⚠️ **Doc STORICO, in parte
> SUPERATO** (nota 2026-06-01): la roadmap definitiva è in `CONTESTO.md`; il modello
> dati multigioco è `MULTIGIOCO_SPEC §4` (`GiocoLega/SessioneGioco/PartitaGioco`),
> **non** la bozza `PartitaSemplice` qui sotto; il "tavolo interattivo (locale)" è
> **già fatto** (feature tavoli T1–T3 in `main`). Si tiene come ragionamento
> "perché/quando", non come specifica operativa.
