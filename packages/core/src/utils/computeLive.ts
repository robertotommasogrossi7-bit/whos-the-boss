...
/* ══════════════════════════════════════════════════════
   COMPUTE LIVE — cash game calcolatrice (§4 SETTLEMENT_SPEC).
   Funzione PURA (niente React): vive in core, riusata da store e UI.
     dovuto  = entrata + sum(ricariche.importo)
     versato = g.versato
